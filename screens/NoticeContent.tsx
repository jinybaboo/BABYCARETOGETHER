...
import { BasicView, LineE2E2E2, LineF2F2F2, MainFlatList, PaddingView, Space10, Space15, Space20, Space35, Space5 } from "../common/commonStyledComp";
    ...
    const renderMainFlatList = ({item, index}:any) => {		
        ...
        return(			
            ...
            <PaddingView>
                <ContentTopInfoBox>
                    <WriteTimeInnerBox>
                        ...
                        <WriteTimeTxt>2022.02.21</WriteTimeTxt>
                    </WriteTimeInnerBox>
            ...
            <PaddingView>
                ...
                <ContentTxt>
                '우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클우승 후보' 미국이 주장 마이크 트라웃(32·LA 에인절스)의 활약 덕에 2023 월드베이스볼클스볼클래식(WBC) {'\n\n'}8강행 막차 티켓을 확보했다. 반면 '초호화 군단' 도미니카공화국은 이번 대회 가장 큰 이변의 희생양이 됐다.
                </ContentTxt>
                <ContentImgBox>
                    <AutoHeightImage source={require('../assets/profile/hl.jpeg')} width={imageWidth} style={{borderRadius:8}}/> 
                </ContentImgBox>
